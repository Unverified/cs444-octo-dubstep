...
;==============================================================================================
    ...
    (rule 'PACKAGE_IMPORT (list 'import 'IDS 'dot 'star 'semi))

;==============================================================================================
;==== Interface Declaration
;==============================================================================================

    (rule 'INTERFACE_DECLARATION (list 'public 'INTERFACE_MODIFIER 'interface 'id 'INTERFACE_EXTENDS 'INTERFACE_BODY))

    (rule 'INTERFACE_EXTENDS (list 'extends 'IEXTENDS_TYPE_LIST))
    (rule 'INTERFACE_EXTENDS empty)

    (rule 'IEXTENDS_TYPE_LIST (list 'IEXTENDS_TYPE_LIST 'comma 'IDS))
    (rule 'IEXTENDS_TYPE_LIST (list 'IDS))
...
;==============================================================================================
    ...
    (rule 'INTERFACE_BODY_DECLARATION (list 'IABSTRACT_METHOD_DECLARATION))
    ...
    (rule 'IABSTRACT_METHOD_DECLARATION (list 'public 'abstract 'TYPE 'METHOD_DECLARATOR 'semi))
